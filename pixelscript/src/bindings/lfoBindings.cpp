...
#define SWIG_name      "lfo"
#define SWIG_init      luaopen_lfo
#define SWIG_init_user luaopen_lfo_user

#define SWIG_LUACODE   luaopen_lfo_luacode
...
static int _wrap_clock(lua_State* L) { int SWIG_arg = 0; int arg1 ; bool result; SWIG_check_num_args("lfo::clock",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("lfo::clock",1,"int"); arg1 = (int)lua_tonumber(L, 1); result = (bool)lfo::clock(arg1);
  lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_tick(lua_State* L) { int SWIG_arg = 0; double arg1 ; double result; SWIG_check_num_args("lfo::tick",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("lfo::tick",1,"double"); arg1 = (double)lua_tonumber(L, 1);
  result = (double)lfo::tick(arg1); lua_pushnumber(L, (lua_Number) result); SWIG_arg++; return SWIG_arg; if(0) SWIG_fail; fail:
